...
class ClockPainter extends CustomPainter {
  ...
  //12 hours -360, ! hour - 30degrees, 1 min - 0.6 degrees
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var minuteHandBrush = Paint()
      ..shader = RadialGradient(colors: [Color(0xFF748EF6), Color(0XFF77DFF)])
    ...
    var secondHandX = centerX + radius * 0.6 * cos(dateTime.second * 6 * pi / 180);
    var secondHandY = centerX + radius * 0.6 * sin(dateTime.second * 6 * pi / 180);

    var minuteHandX = centerX + radius * 0.6 * cos(dateTime.minute * 6 * pi / 180);
    var minuteHandY = centerX + radius * 0.6 * sin(dateTime.minute * 6 * pi / 180);
